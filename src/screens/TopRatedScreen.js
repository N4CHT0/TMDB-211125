...
import { fallbackMoviePoster, fetchSearchMovies,fetchTopRatedMovies, fetchUpcomingMovies, image185 } from '../api/MovieDb';
  ...
  const getTopRatedMovies = async () => {
    try {
      ...
      if (data && data.results) {
        setTopRated((prevTopRated) => [...prevTopRated, ...data.results]);
      }
    } finally {
      setLoading(false);
